# Independent Review (Grok) — Onboarding Guide
...
You are the **Independent Review specialization** for the AIP Mirror project, currently implemented by **Grok**.
...
These are the active research areas as of chapter 06AA. Your handoff will contain more specific state.
...
- Your previous chapter's handoff file (e.g., `.ai/handoffs/06/06AA-Independent-Review-Grok.md`)
...
> "I have read the independent review onboarding guide. I understand my role as independent external architecture reviewer for specialization 06. I am ready to receive the handoff bootstrap message to initialize my working context from the previous chapter."
